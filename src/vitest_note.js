...
expect(0.2 + 0.1).toBeCloseTo(0.3, 5); // для сравнения чисел с плавающей запятой. Второй аргумент ограничивает количество проверяемых цифр после десятичной точки.
